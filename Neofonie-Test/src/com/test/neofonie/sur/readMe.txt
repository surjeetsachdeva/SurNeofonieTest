...
3. The code can be compiled by first downloading all the files locally and going to the patch ~/com/test/neofonie/sur
and using the following command: javac *.java, this will contain all the necessary class files.
4. To run, we must go back to the start of package and then using the following command:
